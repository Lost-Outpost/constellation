...
1. Create a folder for the List at the root of your drive (like the Wabbajack folder) called "Constellation"
...
3. Download the latest release of `Constellation` from the Wabbajack Browse Modlists page
...
Make sure the dropdown box on the right is set to `Constellation` and press the Run button.

# Issues

For issues, you can provide details in the [Constellation Github](https://github.com/Lost-Outpost/thepath/issues). Please provide as much info as you can (screenshots are great).

Finally, free feel to hop on the Constellation Discord support channel to have discussions with our knowledgeable community members. Support is offered in [The Lost Outpost](https://discord.gg/WF66mMu).
